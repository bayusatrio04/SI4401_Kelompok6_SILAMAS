        ...
        <div class="container mb-3">
            <div class="inner-cotainer">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="content">
                            <span class="text-center"><img src="../assets/images/logo/logo.png"  class="mb-3 text-center mx-auto" width="30%" alt=""></span>
                                ...
                                @enderror
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" id="role" name="role">
                                      <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }} disabled>Admin</option>
